...
The typical report card analysis pipeline invovles the following
stages:
1. Import data 
    - ecological data
	- guidelines data
	- hierarchical structural data
2. Prepare data
    - add hierarchical structures to the ecological data
...
examples/templates for inputs into the routines.  Furthermore, there
is a vignette that provides a full demonstration of using the provided
data to generate report cards scores and grades.
